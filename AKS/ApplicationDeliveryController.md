    ...
    ## Common Solutions
    - SKUDONET. Full ADC with WAF, SSL offloading, global traffic management. Expensive, but fully managed by Microsoft.
    - NGINX+ModSecurity. Open-source ADC with WAF capabilities. OWASP Core Rule Set support. Can be deployed in AKS.
    - HAProxy + ModSecurity. Another open-source ADC with WAF capabilities. Extremely fast and stable.
